...
```bash
.agents/skills/verify-mamuso-dev/bin/control-mamuso launch
.agents/skills/verify-mamuso-dev/bin/control-mamuso doctor
BASE="$(.agents/skills/verify-mamuso-dev/bin/control-mamuso url)"
```
...
Write under `.agents/skills/verify-mamuso-dev/artifacts/<feature-id>/`. Keep that tree across cleanup.
...
```bash
.agents/skills/verify-mamuso-dev/bin/control-mamuso cleanup
```
...
```bash
.agents/skills/verify-mamuso-dev/bin/control-mamuso launch [--port 3010] [--host 127.0.0.1]
.agents/skills/verify-mamuso-dev/bin/control-mamuso doctor
.agents/skills/verify-mamuso-dev/bin/control-mamuso url
.agents/skills/verify-mamuso-dev/bin/control-mamuso curl --path /feed.xml --out .agents/skills/verify-mamuso-dev/artifacts/feed/feed.xml
.agents/skills/verify-mamuso-dev/bin/control-mamuso cleanup
```
