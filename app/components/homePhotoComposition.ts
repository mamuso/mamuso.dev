...
// Five foreground prints, followed by two raised prints behind the row.
...
export const homePhotoSlots = [
  { name: 'row-1', portrait: false, x: 0, y: 72, width: 140, height: 94, layer: 7 },
  { name: 'row-2', portrait: true, x: 0.25, y: 72, width: 80, height: 120, layer: 6 },
  { name: 'row-3', portrait: true, x: 0.5, y: 72, width: 80, height: 120, layer: 5 },
  { name: 'row-4', portrait: false, x: 0.75, y: 72, width: 140, height: 94, layer: 4 },
  { name: 'row-5', portrait: true, x: 1, y: 72, width: 80, height: 120, layer: 3 },
  { name: 'back-left', portrait: false, x: 0.52, y: 20, width: 140, height: 94, layer: 1 },
  { name: 'back-right', portrait: false, x: 0.74, y: 32, width: 140, height: 94, layer: 2 },
] as const
