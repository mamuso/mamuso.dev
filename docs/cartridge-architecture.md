...
650 ms return sets the child transform exactly to identity. Reduced-motion users
...
220 ms; stalled frames reset that duration. This is an energy heuristic, not
